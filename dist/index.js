...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(1), __webpack_require__(8)(module)))
...
var lodash_throttle = __webpack_require__(4);
var lodash_throttle_default = /*#__PURE__*/__webpack_require__.n(lodash_throttle);

// EXTERNAL MODULE: ./node_modules/lodash.find/index.js
var lodash_find = __webpack_require__(2);
var lodash_find_default = /*#__PURE__*/__webpack_require__.n(lodash_find);

// EXTERNAL MODULE: ./node_modules/resize-observer-polyfill/dist/ResizeObserver.es.js
var ResizeObserver_es = __webpack_require__(5);

// CONCATENATED MODULE: ./src/utils.js
var noop = function noop() {};
var isSupportPassive = function isSupportPassive() {
...
var requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function (cb) {
  window.setTimeout(cb, 1000 / 60);
};
var cancelAnimationFrame = window.cancelAnimationFrame || window.mozCancelAnimationFrame || function (id) {
  window.clearTimeout(id);
};
// CONCATENATED MODULE: ./src/Item.jsx
...
function (_React$Component) {
  ...
  function Item(props) {
    ...
    _this.listenerElementResize = _this.listenerElementResize.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  var _proto = Item.prototype;

  _proto.listenerElementResize = function listenerElementResize(entries) {
  ...
  _proto.cacheItemSize = function cacheItemSize() {
  ...
  _proto.componentDidMount = function componentDidMount() {
    // this.cacheItemSize()
    this.ob = new ResizeObserver_es["a" /* default */](this.listenerElementResize);
...
// CONCATENATED MODULE: ./src/Rectangle.js
var Rectangle =
/*#__PURE__*/
function () {
  ...
  _proto.getRectInfo = function getRectInfo() {
    return {
      top: this._top,
      height: this._height,
      index: this._index,
  ...
  _proto.updateRectInfo = function updateRectInfo(_temp2) {
...
// CONCATENATED MODULE: ./src/createScheduler.js
...
/* harmony default export */ var src_createScheduler = (createScheduler);
// CONCATENATED MODULE: ./src/computed.js
function computed(context) {
  if (context === void 0) {
    context = null;
  }
...
var src_VirtualizedList =
/*#__PURE__*/
function (_React$Component) {
  src_inheritsLoose(VirtualizedList, _React$Component);
  ...
  function VirtualizedList(props) {
    ...
    _this.items = [];
    _this.rects = Object.create(null); // Format item and set it default position info
    // TODO: memorized

    _this.getFormatItems = computed(src_assertThisInitialized(src_assertThisInitialized(_this)), function (props) {
      return props.data;
    }, function (props) {
      return props.uniqueField;
    }, function (props) {
      return props.estimatedItemHeight;
    }, function (data, uniqueField, defaultHeight) {
      var res = [].concat(_this.items);
      var length = res.length;
      var lastItem = res[length - 1];
      var lastRect = lastItem ? _this.rects[lastItem.id] : null;
      ...
      for (var i = length; i < data.length; i++) {
        ...
        _this.rects[item[uniqueField]] = new Rectangle({
          top: top,
          height: 0,
          index: i,
          id: item[uniqueField],
    ...
    _this.isLoadingNextPageData = false;
    _this.timer = null;
    _this.doc = null;
    _this.el = null; // The info of anchor element
    ...
    _this.updateItemPosition = _this.updateItemPosition.bind(src_assertThisInitialized(src_assertThisInitialized(_this)));
    _this.handleScroll = _this.handleScroll.bind(src_assertThisInitialized(src_assertThisInitialized(_this)));
    _this.scrollListener = lodash_throttle_default()(src_createScheduler(_this.handleScroll, requestAnimationFrame), 100, {
      trailing: true
    });
    return _this;
  }
  ...
  _proto.updateItemPosition = function updateItemPosition(node, id, index) {
    ...
    var top = rect.top - this.containerTopValue + (this.el.scrollTop || window.pageYOffset);
  ...
  _proto.getRenderItems = function getRenderItems(callback) {
    if (callback === void 0) {
      callback = noop;
    }

    // Get the render data
    var estimatedItemHeight = this.props.estimatedItemHeight;
    var visibleData = this.items.slice(this.startIndex, this.endIndex);
    this.setState({
  ...
  _proto.getVisibleCount = function getVisibleCount() {
    ...
    var h = useWindow ? window.innerHeight : this.el.offsetHeight;
    return Math.ceil(h / estimatedItemHeight) + bufferSize;
  };

  _proto.initVisibleData = function initVisibleData() {
    this.visibleCount = this.getVisibleCount();
    this.endIndex = this.startIndex + this.visibleCount;
    this.getRenderItems();
  };

  _proto.updateVisibleData = function updateVisibleData() {
  ...
  _proto.scrollUp = function scrollUp(scrollTop) {
    var _this$props2 = this.props,
        bufferSize = _this$props2.bufferSize,
        hasMore = _this$props2.hasMore,
        data = _this$props2.data; // Hand is scrolling up
    ...
    if (scrollTop > this.anchorItem.bottom) {
      var rect = lodash_find_default()(this.rects, function (rect) {
        return rect.getBottom() >= scrollTop;
      });
      ...
      var endIndex = this.anchorItem.index + this.visibleCount;
  ...
  _proto.scrollDown = function scrollDown(scrollTop) {
    var _this$props3 = this.props,
        bufferSize = _this$props3.bufferSize,
        data = _this$props3.data; // Hand is scrolling down
  ...
  _proto.handleScroll = function handleScroll(e) {
    ...
    this.props.onScroll(e); // Set a timer to judge scroll of element is stopped

    this.timer && clearTimeout(this.timer);
    this.timer = setTimeout(function () {
      _this2.handleScrollEnd();
    }, 300);
    var curScrollTop = this.doc.scrollTop;
  ...
  _proto.handleScrollEnd = function handleScrollEnd() {// Do something, when scroll stop
  };

  _proto.getTombstoneHeight = function getTombstoneHeight(index) {
    var h = this.rects[this.items[index].id].getHeight();
  ...
  _proto.getScrollableElement = function getScrollableElement() {
    var _this$props4 = this.props,
        scrollableTarget = _this$props4.scrollableTarget,
  ...
  _proto.render = function render() {
    ...
    var _this$props5 = this.props,
        ...
        endComponent = _this$props5.endComponent,
        hasMore = _this$props5.hasMore,
        data = _this$props5.data;
    var _this$state = this.state,
        paddingBottom = _this$state.paddingBottom,
        paddingTop = _this$state.paddingTop,
        renderItems = _this$state.renderItems;
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement("div", {
      ...
      return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(src_Item, {
        key: item.id,
        item: item,
        itemIndex: _this3.startIndex + index // height={`${this.getTombstoneHeight(this.startIndex + index)}`}
        ,
        renderItem: _this3.props.renderItem,
        updateItemPosition: _this3.updateItemPosition
      });
...
src_VirtualizedList.defaultProps = {
  data: [],
...
/* harmony default export */ var src = __webpack_exports__["default"] = (src_VirtualizedList);
